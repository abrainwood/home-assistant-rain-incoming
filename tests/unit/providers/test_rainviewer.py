...
@pytest.mark.skip(reason="experiment branch #195-palette-v4: tests pin V2 production palette; this branch deliberately uses V4 layout (V2 + middle + outermost trace tiers)")
