...
class TestColourToIntensity:
    ...
    @pytest.mark.skip(reason="GH #180 experiment: (170,158,121) reclassified as trace precipitation tier on this branch; original test will be rewritten when the winning variant lands")
