...
class TestGridToTilePng:
    ...
    @pytest.mark.skip(reason="experiment branch #195-palette-v5: V5 removes the lowest blue tier, leaving a gap that the 90% roundtrip recovery threshold cannot clear")
