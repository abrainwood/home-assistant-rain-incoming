...
class TestPerthFalseNegative20260427:
    ...
    @pytest.mark.skip(reason="experiment branch #195-palette-v8: V8 strict palette filters out the light-rain pixels that this golden window relies on for detection")
