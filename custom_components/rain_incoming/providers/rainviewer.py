...
PRECIP_COLOURS: list[tuple[int, int, int, float]] = [
    # GH #180 experiment V4: all three previously-undocumented trace tiers.
    (218, 204, 147, 0.02), # trace (~3-5 dBZ, RainViewer khaki tier 3 - lightest)
    (206, 192, 135, 0.05), # trace very light (~7-10 dBZ, RainViewer khaki tier 2)
